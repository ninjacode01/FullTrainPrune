...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv2 = layers.Conv2d(planes, planes, kernel_size=3,
        ...
        if stride != 1 or in_planes != self.expansion*planes:
            self.shortcut = nn.Sequential(
                layers.Conv2d(in_planes, self.expansion*planes,
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn2 = layers.BatchNorm2d(planes)
        self.conv3 = layers.Conv2d(planes, self.expansion *
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = layers.Conv2d(3, 64, kernel_size=3,
                               stride=1, padding=1, bias=False)
        self.bn1 = layers.BatchNorm2d(64)
...
def ResNet18(input_shape, num_classes,dense_classifier,pretrained):
